<template>
  <div class="container">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMin slice" viewBox="0 0 728 400">
      <!--Background-->
      <path d="M0 0h728v400H0z" fill="#333333" />
      <!--Spiral path-->
      <defs>
      ...
      <!--Text & link to path-->
      <text font-family="monospace" font-size="20" fill="currentColor">
...
export default {
  data() {
    return {
      anim: null,
      text: "Text here Lorem ipsum dolor sit amet consectetur, adipisicing elit. Soluta ipsum dolor accusamus harum suscipit! Similique explicabo veritatis eveniet voluptate aperiam, est neque quas quo dolorem at enim quaerat unde! Quos, animi facere aliquam, eveniet delectus, magnam illo perferendis commodi optio voluptatibus ducimus quasi molestias. Fugit amet incidunt architecto eius quia! "
    };
  },
  mounted() {
    this.anim = gsap.to("#text", {
      duration: 15,
      text: this.text
    });
  }
